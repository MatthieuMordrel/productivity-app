          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mx-auto mt-6 max-w-2xl text-xl">
                Plan your day with structured schedules. Balance work and breaks
                for peak efficiency.
              </p>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              ...
              <p className="mx-auto mb-10 max-w-2xl text-xl">
                Start planning your day with our intuitive calendar and discover
                the power of structured schedules.
              </p>
